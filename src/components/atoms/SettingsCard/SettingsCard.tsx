...
export const SettingsCard: React.FC<SettingsCardProps> = ({
  ...
  return (
    <div className={`p-6 sm:p-8 bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-md border border-white/50 rounded-xl ring-1 ring-white/20 mb-6 ${className}`}>
