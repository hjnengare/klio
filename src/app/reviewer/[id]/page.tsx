                    ...
                    <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 py-4">
                        <nav className="flex items-center justify-between" aria-label="Reviewer profile navigation">
                            ...
                            >
                                ...
                                <h1 className="font-urbanist text-sm sm:text-base font-700 text-white animate-delay-100 animate-fade-in truncate max-w-[150px] sm:max-w-none" style={{ fontFamily: '"SF Pro New", -apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
                                    {reviewer.name}
                                </h1>
                            </Link>
