        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <FadeInUp delay={0.1}>
            ...
            >
              ...
              <h1 className="font-sf text-8xl md:text-9xl font-800 text-transparent bg-clip-text bg-gradient-to-r from-charcoal via-sage to-charcoal mb-2 relative">
                404
                {/* Subtle glow effect */}
                <div className="absolute inset-0 font-sf text-8xl md:text-9xl font-800 text-sage/10 blur-2xl -z-10">
                  404
                </div>
              </h1>
          ...
          <FadeInUp delay={0.3}>
            <h2 className="font-sf text-3xl md:text-4xl font-700 text-charcoal mb-4">
              Oops! Page Not Found
            </h2>
          </FadeInUp>

          <FadeInUp delay={0.4}>
            <p className="font-sf text-lg md:text-xl font-400 text-charcoal/70 mb-8 max-w-lg mx-auto leading-relaxed">
          ...
          <FadeInUp delay={0.6}>
            <div className="mt-12 pt-8 border-t border-sage/10">
              <p className="font-sf text-sm font-500 text-charcoal/50 mb-4">
                Popular pages:
              </p>
