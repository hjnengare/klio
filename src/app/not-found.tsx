    ...
    <div className="min-h-dvh bg-gradient-to-br from-off-white via-off-white/98 to-off-white/95 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-dvh px-4 py-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <FadeInUp delay={0.1}>
            ...
            >
              ...
              <h1 className="font-urbanist text-8xl md:text-9xl font-800 text-transparent bg-clip-text bg-gradient-to-r from-charcoal via-sage to-charcoal mb-2 relative">
                404
                {/* Subtle glow effect */}
                <div className="absolute inset-0 font-urbanist text-8xl md:text-9xl font-800 text-sage/10 blur-2xl -z-10">
                  404
                </div>
              </h1>
          ...
          <FadeInUp delay={0.3}>
            <h2 className="font-urbanist text-3xl md:text-4xl font-700 text-charcoal mb-4">
              Oops! Page Not Found
            </h2>
          </FadeInUp>
          ...
          <FadeInUp delay={0.5}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
              ...
              <PremiumHover scale={1.02}>
                <Link
                  href="/interests"
                  className="inline-flex items-center justify-center gap-2 w-full sm:w-auto py-4 px-8 bg-gradient-to-r from-sage to-sage/90 text-white font-urbanist font-600 text-lg rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-sage/20 group"
                >
              ...
              <PremiumHover scale={1.02}>
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 w-full sm:w-auto py-4 px-8 bg-white  /80 backdrop-blur-sm text-charcoal font-urbanist font-600 text-lg rounded-2xl border border-sage/20 shadow-sm transition-all duration-300 hover:shadow-md hover:bg-white  /90 group"
                >
