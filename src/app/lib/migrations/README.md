...
```
migrations/
├── 001_core/           # Core database setup (profiles, auth, users)
├── 002_business/       # Business-related tables and features
├── 003_reviews/        # Review system tables and features
├── 004_storage/        # Storage buckets and file management
└── 005_functions/      # Database functions and utilities
```
