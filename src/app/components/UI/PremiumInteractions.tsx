  ...
  return (
    ...
    >
      ...
      {ripples.map(ripple => (
        ...
        >
          <span className="block w-0 h-0 rounded-full bg-off-white   bg-opacity-30 animate-ping" />
        </span>
      ))}
        ...
        <label
          className={`
            ...
            ${isFocused || hasValue || !animatedPlaceholder
              ? 'top-0 -translate-y-1/2 text-xs bg-off-white   px-1 text-blue-600'
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className={`
          relative bg-off-white   rounded-xl shadow-2xl w-full ${sizeClasses[size]}
          transition-all duration-300 ease-out
