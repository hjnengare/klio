...
export default function EventActionCard() {
  return (
    ...
    >
      <h3 className="text-sm font-bold text-charcoal mb-3" style={{ fontFamily: '"Changa One", cursive, sans-serif' }}>Join This Event</h3>

      <div className="space-y-3">
        <button className="w-full bg-charcoal text-white font-600 py-3 px-5 rounded-full transition-all duration-300 hover:bg-charcoal/90 hover:shadow-lg text-sm" style={{ fontFamily: '"Livvic", sans-serif', fontWeight: 600 }}>
          Reserve Your Spot
        </button>

        <button className="w-full bg-white/40 text-charcoal font-600 py-3 px-5 rounded-full transition-all duration-300 hover:bg-charcoal hover:text-white hover:shadow-lg text-sm" style={{ fontFamily: '"Livvic", sans-serif', fontWeight: 600 }}>
          Contact Organizer
        </button>
      </div>

      <div className="mt-4 pt-4 border-t border-charcoal/10">
        <h4 className="text-sm font-semibold text-charcoal/80 mb-2.5" style={{ fontFamily: '"Changa One", cursive, sans-serif' }}>Share Event</h4>
