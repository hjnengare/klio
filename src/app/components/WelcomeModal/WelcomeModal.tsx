          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-sage/10 via-coral/5 to-sage/10 p-6 sm:p-8 pb-6">
                ...
                <h2 className="font-urbanist text-2xl sm:text-3xl font-700 text-charcoal text-center mb-2">
                  Welcome to KLIO
                </h2>
              ...
              <div className="p-6 sm:p-8 pt-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 items-start">
                    <div className="w-10 h-10 bg-charcoal/10 rounded-xl flex items-center justify-center flex-shrink-0">
