    ...
    <section className="py-12 bg-white/90">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="font-urbanist text-3xl md:text-4xl font-700 text-transparent bg-clip-text bg-gradient-to-r from-charcoal via-charcoal/90 to-sage mb-4">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="text-center mb-4">
                  <h3 className="font-urbanist text-xl font-700 text-charcoal group-hover:text-sage transition-colors duration-300 mb-2">
                    {business.name}
                  </h3>
