    ...
    <>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 text-white/80 font-medium" style={{ fontFamily: '"Livvic", sans-serif', fontWeight: 600 }}>or continue with</span>
        </div>
      </div>
