          ...
          {businesses[1].href ? (
            <Link href={businesses[1].href} className="block">
              <div className="relative mb-2 sm:mb-3">
                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 relative rounded-xl overflow-hidden border-3 sm:border-4 border-white shadow-[0_8px_30px_rgba(0,0,0,0.2)] mx-auto ring-3 sm:ring-4 ring-coral/30">
                  <FallbackImage
              ...
              <div className="font-urbanist text-body-sm sm:text-body font-700 text-charcoal mb-1 truncate px-2">{businesses[1].name}</div>
        ...
        >
          {businesses[0].href ? (
            <Link href={businesses[0].href} className="block">
              <div className="relative mb-2 sm:mb-3">
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 relative rounded-xl overflow-hidden border-3 sm:border-4 border-white shadow-[0_12px_40px_rgba(0,0,0,0.25)] mx-auto ring-3 sm:ring-4 ring-sage">
                  <FallbackImage
              ...
              <div className="font-urbanist text-body sm:text-h3 font-700 text-charcoal mb-1 truncate px-2">{businesses[0].name}</div>
              <div className="font-urbanist text-caption sm:text-body-sm text-charcoal/60 mb-2 flex items-center justify-center gap-1">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 text-coral fill-coral" />
        ...
        >
          {businesses[2].href ? (
            <Link href={businesses[2].href} className="block">
              <div className="relative mb-2 sm:mb-3">
                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 relative rounded-xl overflow-hidden border-3 sm:border-4 border-white shadow-[0_8px_30px_rgba(0,0,0,0.2)] mx-auto ring-3 sm:ring-4 ring-charcoal/20">
                  <FallbackImage
              ...
              <div className="font-urbanist text-body-sm sm:text-body font-700 text-charcoal mb-1 truncate px-2">{businesses[2].name}</div>
              <div className="font-urbanist text-caption sm:text-body-sm text-charcoal/60 mb-2 flex items-center justify-center gap-1">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 text-coral fill-coral" />
