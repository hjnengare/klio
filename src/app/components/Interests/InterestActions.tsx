  ...
  return (
    <div className="pt-4 space-y-4 enter-fade" style={{ animationDelay: "0.15s" }}>
      <button
          ...
          ${
            canProceed
              ? "bg-sage shadow-[0_10px_40px_rgba(125,155,118,0.25),0_4px_12px_rgba(0,0,0,0.08)] hover:bg-sage/90 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(125,155,118,0.35),0_8px_24px_rgba(0,0,0,0.12)] focus:outline-none focus:ring-4 focus:ring-sage/30 focus:ring-offset-2"
      ...
      >
        ...
        {canProceed && (
          <span className="pointer-events-none absolute inset-0 rounded-full bg-sage/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        )}
      </button>
