...
export default function AIChat() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] max-w-[calc(100vw-3rem)] h-[600px] max-h-[calc(100vh-8rem)] bg-white rounded-2xl shadow-2xl border border-charcoal/10 flex flex-col overflow-hidden">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-off-white/50">
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-sage text-white rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-2">
