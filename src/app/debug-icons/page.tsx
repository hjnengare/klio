  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Manual icon test */}
        <section className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Manual Icon Test</h2>
          <div className="flex gap-4 flex-wrap">
            <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm border border-white/60 backdrop-blur-sm">
              <Zap className="w-3.5 h-3.5 text-sage" />
              <span className="font-sf text-sm font-700 text-sage">85%</span>
            </div>
            <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm border border-white/60 backdrop-blur-sm">
              <Heart className="w-3.5 h-3.5 text-sage" />
              <span className="font-sf text-sm font-700 text-sage">92%</span>
            </div>
            <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm border border-white/60 backdrop-blur-sm">
              <Star className="w-3.5 h-3.5 text-sage" />
              <span className="font-sf text-sm font-700 text-sage">78%</span>
            </div>
          </div>
        </section>
      </div>
