...
"[project]/src/app/lib/supabase/client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/supabase/client.ts [app-client] (ecmascript)");
;
class AuthService {
    static getClient() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrowserSupabase"])();
    }
...
function AuthProvider(param) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrowserSupabase"])();
        ...
        "AuthProvider.useEffect": ()=>{
            const initializeAuth = {
                "AuthProvider.useEffect.initializeAuth": async ()=>{
                    setIsLoading(true);
                    try {
                        const currentUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].getCurrentUser();
                        setUser(currentUser);
                    } catch (error) {
    ...
    const login = async (email, password)=>{
        ...
        setError(null);
        try {
            const { user: authUser, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].signIn({
                email,
                password
            });
            if (authError) {
            ...
            if (authUser) {
                var _authUser_profile;
                setUser(authUser);
                // Redirect based on onboarding status
                if ((_authUser_profile = authUser.profile) === null || _authUser_profile === void 0 ? void 0 : _authUser_profile.onboarding_complete) {
                    router.push('/home');
                } else {
                    var _authUser_profile1;
                    router.push("/".concat(((_authUser_profile1 = authUser.profile) === null || _authUser_profile1 === void 0 ? void 0 : _authUser_profile1.onboarding_step) || 'interests'));
                }
            }
            setIsLoading(false);
            return true;
    ...
    const register = async (email, password)=>{
        ...
        setError(null);
        try {
            const { user: authUser, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].signUp({
                email,
                password
            });
            if (authError) {
    ...
    const logout = async ()=>{
        ...
        setError(null);
        try {
            const { error: signOutError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].signOut();
            if (signOutError) {
...
"[project]/src/app/contexts/ToastContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ToastProvider(param) {
    ...
    const generateUniqueId = ()=>{
        return "toast_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
    };
    const showToast = function(message) {
        let type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'info', duration = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 4000;
...
"[project]/src/app/contexts/OnboardingContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OnboardingProvider(param) {
    let { children } = param;
    var _user_profile;
    _s();
    const { user, updateUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [subInterests, setSubInterests] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [selectedSubInterests, setSelectedSubInterests] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedDealbreakers, setSelectedDealbreakers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const currentStep = (user === null || user === void 0 ? void 0 : (_user_profile = user.profile) === null || _user_profile === void 0 ? void 0 : _user_profile.onboarding_step) || 'interests';
    const loadInterests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OnboardingProvider.useCallback[loadInterests]": async ()=>{
            try {
                setIsLoading(true);
                setError(null);
    ...
    }["OnboardingProvider.useCallback[loadInterests]"], []);
    const loadSubInterests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OnboardingProvider.useCallback[loadSubInterests]": async (interestIds)=>{
            try {
                setIsLoading(true);
                setError(null);
                const qs = interestIds.length ? "?interests=".concat(interestIds.join(",")) : "";
                const res = await fetch("/api/subcategories".concat(qs), {
                    cache: "no-store"
                });
    ...
    }["OnboardingProvider.useCallback[loadSubInterests]"], []);
    ...
    const getStepCompletionMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OnboardingProvider.useCallback[getStepCompletionMessage]": (step)=>{
            switch(step){
                case 'interests':
                    return "Great! ".concat(selectedInterests.length, " interests selected. Let's explore sub-categories!");
                case 'subcategories':
                    return "Perfect! ".concat(selectedSubInterests.length, " sub-interests added. Now let's set your dealbreakers.");
                case 'deal-breakers':
                    return "Excellent! ".concat(selectedDealbreakers.length, " dealbreakers set. Almost done!");
                default:
                    return 'Step completed successfully!';
            }
        }
    }["OnboardingProvider.useCallback[getStepCompletionMessage]"], [
    ...
    const nextStep = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OnboardingProvider.useCallback[nextStep]": async ()=>{
            if (!user) return;
            try {
                setIsLoading(true);
                setError(null);
                ...
                if (nextStepName === 'complete') {
                    ...
                    const interestParams = selectedInterests.length > 0 ? "?interests=".concat(selectedInterests.join(',')) : '';
                    router.push("/subcategories".concat(interestParams));
                } else {
                    router.push("/".concat(nextStepName));
                }
            } catch (error) {
    ...
    const completeOnboarding = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OnboardingProvider.useCallback[completeOnboarding]": async ()=>{
            if (!user) return;
            try {
                setIsLoading(true);
                setError(null);
    ...
    }["OnboardingProvider.useCallback[completeOnboarding]"], [
        user,
        selectedInterests,
        selectedSubInterests,
        selectedDealbreakers,
...
_s(OnboardingProvider, "ZFCU/JljRPeP5tr+ZumwrbM9/xY=", false, function() {
    return [
...
"[project]/src/app/components/Providers/PageTransitionProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(usePageTransition, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
...
_s1(PageTransitionProvider, "EmvgwIb3cHpoFpeP+WmEDbjx4y4=");
...
"[project]/src/app/components/Performance/WebVitals.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/components/ErrorBoundary/ErrorBoundary.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    componentDidCatch(error, errorInfo) {
        var // Call optional error callback
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "w-full font-sf text-base font-600 py-3 px-6 rounded-2xl transition-colors duration-300 focus:outline-none focus:ring-2 ".concat(isRepeatedError ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-sage text-white hover:bg-sage/90 focus:ring-sage/30'),
...
"[project]/src/app/hooks/useBusinessNotifications.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useBusinessNotifications() {
    ...
    const lastNotificationTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBusinessNotifications.useEffect": ()=>{
            ...
            const handleNewBusiness = {
                "useBusinessNotifications.useEffect.handleNewBusiness": (payload)=>{
                    var _payload_new;
                    const now = Date.now();
                    ...
                    const businessName = ((_payload_new = payload.new) === null || _payload_new === void 0 ? void 0 : _payload_new.name) || 'A new business';
                    showToast("".concat(businessName, " just joined KLIO! 🎉"), 'sage', 6000);
                }
            }["useBusinessNotifications.useEffect.handleNewBusiness"];
            // Subscribe to new inserts in the businesses table
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('business-notifications').on('postgres_changes', {
                event: 'INSERT',
                schema: 'public',
                table: 'businesses'
            }, handleNewBusiness).subscribe({
                "useBusinessNotifications.useEffect.channel": (status)=>{
                    if (status === 'SUBSCRIBED') {
                        console.log('✅ Subscribed to business notifications');
                    }
                }
            }["useBusinessNotifications.useEffect.channel"]);
            subscriptionRef.current = channel;
            // Cleanup subscription on unmount
            return ({
                "useBusinessNotifications.useEffect": ()=>{
                    if (subscriptionRef.current) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(subscriptionRef.current);
...
_s(useBusinessNotifications, "sCcA4bDJhhwZqrqowQ4X4CRhzjo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$contexts$2f$ToastContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
"[project]/src/app/components/Notifications/BusinessNotifications.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useBusinessNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/hooks/useBusinessNotifications.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
function BusinessNotifications() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useBusinessNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBusinessNotifications"])();
    // This component doesn't render anything - it just sets up the subscription
    return null;
}
_s(BusinessNotifications, "oadJ6m4+uZBRcYqkE45GSayba+8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useBusinessNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBusinessNotifications"]
    ];
});
_c = BusinessNotifications;
var _c;
__turbopack_context__.k.register(_c, "BusinessNotifications");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_app_7545b17c._.js.map